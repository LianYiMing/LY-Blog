    ...
    background="#ff442d85";
    {
      ...
      }; 
      {
        ...
        -- background='#FFFFFFFF',--背景颜色或图片路径
        {
          ...
          {
            ImageView;--图片控件
            src='1新工程/account_remove_96x96.png';--图片路径
            layout_width='25dp';--宽度
            layout_height='25dp';--高度
            scaleType='fitXY';--图片显示类型
          };
        ...
        };
        {
          ...
          {
            ImageView;--图片控件
            src='1新工程/dots_vertical_96x96.png';--图片路径
            layout_width='25dp';--宽度
            layout_height='25dp';--高度
            scaleType='fitXY';--图片显示类型
          };
        ...
        };
        {
          ...
          layout_height='fill',--高度
          {
            ...
            background='#ff3f2a79',--背景颜色或图片路径
            {
              ...
              {
                ImageView;--图片控件
                src='1新工程/google_earth_96x96.png';--图片路径
                layout_width='25dp';--宽度
                layout_height='25dp';--高度
